...
export default function Loyalty() {
  return (
    <div className="w-full lg:max-h-screen text-white text-center relative flex items-center">
      ...
      max-w-full"
        >
          <div className="max-w-[75%] 4k:max-w-[50%] flex flex-col-reverse items-center sm:px-5 md:flex-row-reverse gap-0 m-auto">
            <div className="flex flex-col items-start justify-start w-full h-full pt-6 pr-0 pb-6 pl-0 mb-6 md:mb-0 md:w-[80%]">
              <div
            ...
            md:space-y-5"
              >
                <div className="w-full lg:h-full flex flex-col  justify-end mx-[2vw] gap-5">
                  <p className="font-Slider text-3xl lg:text-[5vw] leading-[120%] text-left break-words w-[80%]">
                    Loyalty System
                  </p>
                  <p className="text-sm lg:text-[1.1vw] leading-[150%] pr-10 text-left break-words w-[100%]">
